...
```
## Replace-Command
Der Replace-Command soll eine bereits bestehende Konfiguration editieren. Dazu muss man in der Change.json im Configordner angeben, wo etwas geändert werden muss.
